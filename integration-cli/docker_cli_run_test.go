...
func (s *DockerTrustSuite) TestTrustedRunFromBadTrustServer(c *check.C) {
	repoName := fmt.Sprintf("%v/dockerclievilrun/trusted:latest", s.reg.url)
...
||||||| parent of b4d6236... Add --add-registry and --block-registry options to docker daemon
=======
...
>>>>>>> b4d6236... Add --add-registry and --block-registry options to docker daemon
