...
// AuditVert* constants used when logging an API event to the audit log
const (
	AuditVertControl   = 2500
	AuditVertResource  = 2501
	AuditVertMachineID = 2502
)
...
// LogUserEvent logs info msg from user event or error
...
// FormatVars formats map to string
