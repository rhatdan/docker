...
func (s *Service) searchTerm(term string, authConfig *AuthConfig, headers map[string][]string, noIndex bool, outs *[]SearchResultExt) error {
...
func (s *Service) Search(term string, authConfig *AuthConfig, headers map[string][]string, noIndex bool) ([]SearchResultExt, error) {
	results := []SearchResultExt{}
